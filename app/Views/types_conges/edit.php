...
<div class="container mt-4">
    ...
    <div class="card">
        <div class="card-body">
            <form action="/types-conges/<?= $typeConge['id'] ?>/update" method="POST">
                <?= csrf_field() ?>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="deductible" name="deductible">
                        <option value="1" <?= old('deductible', $typeConge['deductible']) == '1' ? 'selected' : '' ?>>Oui</option>
                        <option value="0" <?= old('deductible', $typeConge['deductible']) == '0' ? 'selected' : '' ?>>Non</option>
                    </select>
                </div>
