...
<div class="container mt-4">
    ...
    <div class="card">
        <div class="card-body">
            <form action="/employes/<?= $employe['id'] ?>/update" method="POST">
                <?= csrf_field() ?>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nom" name="nom" 
                                   value="<?= old('nom', esc($employe['nom'])) ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="prenom" name="prenom" 
                                   value="<?= old('prenom', esc($employe['prenom'])) ?>" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="email" name="email" 
                                   value="<?= old('email', esc($employe['email'])) ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="role" name="role" 
                                   value="<?= old('role', esc($employe['role'] ?? '')) ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
